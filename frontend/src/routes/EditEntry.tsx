...
export default function EditEntry(){
    ...
    return(
        <section className="flex dark:bg-gray-600 justify-center flex-col w-fit ml-auto mr-auto mt-10 gap-5 bg-gray-300 p-8 rounded-md">
            ...
            <input className="p-3 dark:text-black rounded-md" type="date" name="created_at" value={(new Date(newEntry.created_at)).toISOString().split('T')[0]} onChange={handleInputChange}/>
            <button onClick={(e) => {handleSend(e)}} className="dark:bg-slate-700 dark:hover:bg-slate-900 bg-blue-400 hover:bg-blue-600 font-semibold text-white p-3 rounded-md">Update</button>
        </section>
    )
}